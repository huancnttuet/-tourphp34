...
class Users extends MY_Controller
{
    ...
    function signup()
    {
        if (isset($_POST['submit'])) {
         ...
         //check username exist in db
                $exist =$this->users_model->get('*', array('user_name'=>$username));
                if ($exist!=null) {
                ...
                /*gui mail o day*/
                 //
                 //sau khi gui mail thanh cong đưa dữ liệu người dùng đăng kí vào bảng users, activated = 0
                $this->load->model('users_model');
        ...
        parent::_render_frontend_view('frontend/users/signup', null);
    }
    ...
    function verification_email()
    {
        if (isset($_POST['code']) && isset($_SESSION['email'])) {
            ...
            if ($data!=null) {
                ...
                $this->load->model('users_model');
                $this->users_model->updateActivatedEmail($data[0]->email);
        ...
        parent::_render_frontend_view('frontend/users/verification_email', null);
    }
    ...
    function login()
    {
        ...
        parent::_render_frontend_view('frontend/users/login', null);
    }
