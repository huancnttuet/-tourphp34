							...
							<div class="content table-responsive table-full-width">
								<table class="table table-hover table-striped">
									...
									<tr>
										...
										<td> <img class="img-thumbnail img-circle" src="<?php echo $r->image ?>"></td>
										<td> <?php echo $r->noi_khoi_hanh; ?></td>
										<td> <?php echo $r->diem_den; ?></td>
										<td> <?php echo $r->ngay_khoi_hanh; ?></td>
										<td> <?php if($r->loai_tuyen == 1) echo 'Trong nước'; else echo 'Nước ngoài'; ?></td>
