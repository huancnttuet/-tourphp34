...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() ?>statics/assets/img/favicon_16.ico"/>
    <link rel="bookmark" href="<?php echo base_url() ?>statics/assets/img/favicon_16.ico"/>
    <!-- site css -->
    <link rel="stylesheet" href="<?php echo base_url() ?>statics/assets/css/site.min.css">
    ...
    <![endif]-->
    <script type="text/javascript" src="<?php echo base_url() ?>satics/assets/js/site.min.js"></script>
    <style>
      body {
        padding-top: 40px;
        padding-bottom: 40px;
    ...
    <div class="container">
      <form class="form-signin" role="form" method="post">
        ...
        <!-- <label class="checkbox">
          ...
          <label style="padding-top: 12px; font-size: 15px;">Remember me</label>
        </label> -->
